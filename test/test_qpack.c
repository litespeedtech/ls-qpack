...
} header_block_tests[] =
{
...

    {
        ...
        .qhbt_headers       = {
            ...
            { ":method", "GET", 0, },
            /* The "aaa..." string triggers header_out_grow_buf() */
        ...
        .qhbt_header_buf    = {
            ...
            0x50, 0x83, 0xb3, 0xfc,
            0x80 | 0x40 | 17,
            0x20 /* Without name reference */ | 0x08 /* Huffman */ | 7 , 0x0A /* Length */,
            0x18, 0xc6, 0x31, 0x8c, 0x63, 0x18, 0xc6, 0x31, 0x8c,
            0x63, 0x18, 0xc6, 0x31, 0x8c, 0x63, 0x18, 0xff,
            0x80 /* Huffman */ | 17 /* length */,
            0x18, 0xc6, 0x31, 0x8c, 0x63, 0x18, 0xc6, 0x31, 0x8c,
